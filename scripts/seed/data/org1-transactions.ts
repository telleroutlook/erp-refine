  ...
  return [
    {
      ...
      is_active: true,
      items: [
        { product_id: reg.get('product', 'RM-AL-001'), quantity: 2, unit: 'KG', scrap_rate: 5 },
        { product_id: reg.get('product', 'RM-ST-001'), quantity: 0.5, unit: 'M', scrap_rate: 3 },
        { product_id: reg.get('product', 'RM-RB-001'), quantity: 0.3, unit: 'KG', scrap_rate: 2 },
        { product_id: reg.get('product', 'SF-PCB-001'), quantity: 1, unit: 'PCS', scrap_rate: 1 },
      ],
    },
    {
      ...
      is_active: true,
      items: [
        { product_id: reg.get('product', 'RM-ST-002'), quantity: 8, unit: 'KG', scrap_rate: 5 },
        { product_id: reg.get('product', 'RM-CU-001'), quantity: 1.5, unit: 'KG', scrap_rate: 3 },
        { product_id: reg.get('product', 'SF-FR-001'), quantity: 1, unit: 'PCS', scrap_rate: 0 },
        { product_id: reg.get('product', 'SF-SH-001'), quantity: 1, unit: 'PCS', scrap_rate: 0 },
        { product_id: reg.get('product', 'SF-PCB-001'), quantity: 1, unit: 'PCS', scrap_rate: 1 },
      ],
    },
    {
      ...
      is_active: true,
      items: [
        { product_id: reg.get('product', 'RM-ST-001'), quantity: 2, unit: 'M', scrap_rate: 5 },
        { product_id: reg.get('product', 'RM-PL-001'), quantity: 1.5, unit: 'KG', scrap_rate: 3 },
        { product_id: reg.get('product', 'RM-RB-001'), quantity: 0.2, unit: 'KG', scrap_rate: 2 },
      ],
    },
  ];
}
  ...
  return [
    {
      ...
      payment_terms: '45天',
      items: [
        { product_id: reg.get('product', 'FG-VLV-001'), quantity: 200, unit_price: 500, amount: 100000 },
        { product_id: reg.get('product', 'FG-VLV-002'), quantity: 100, unit_price: 750, amount: 75000 },
      ],
    },
    {
      ...
      payment_terms: '30天',
      items: [
        { product_id: reg.get('product', 'FG-VLV-001'), quantity: 4, unit_price: 50000, amount: 200000, notes: '季度设备巡检维保' },
        { product_id: reg.get('product', 'FG-PMP-001'), quantity: 1, unit_price: 300000, amount: 300000, notes: '备件供应' },
      ],
    },
    {
      ...
      payment_terms: '30天',
      items: [
        { product_id: reg.get('product', 'RM-AL-001'), quantity: 10000, unit_price: 44, amount: 440000 },
        { product_id: reg.get('product', 'RM-AL-002'), quantity: 5000, unit_price: 67, amount: 335000 },
      ],
    },
    {
      contract_type: 'sales',
      ...
      payment_terms: '60天',
      items: [
        { product_id: reg.get('product', 'FG-PMP-001'), quantity: 30, unit_price: 3600, amount: 108000 },
        { product_id: reg.get('product', 'FG-PMP-002'), quantity: 15, unit_price: 5400, amount: 81000 },
      ],
    },
  ];
}
