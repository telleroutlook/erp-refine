...
export function org1Departments() {
  return [
    ...
    { code: 'FIN-AP', name: '应付组', level: 2, parent_code: 'FIN' },
    { code: 'FIN-AR', name: '应收组', level: 2, parent_code: 'FIN' },
    { code: 'SALES', name: '销售部', level: 1 },
    { code: 'SALES-DOM', name: '国内销售', level: 2, parent_code: 'SALES' },
    { code: 'SALES-INT', name: '国际销售', level: 2, parent_code: 'SALES' },
...
export function org1Employees() {
  return [
    { name: '张伟', email: 'zhangwei@demo.com', phone: '13800001001', position: '总经理', role: 'admin', employee_number: 'EMP001' },
    { name: '李娜', email: 'lina@demo.com', phone: '13800001002', position: '财务总监', role: 'finance_manager', employee_number: 'EMP002' },
    { name: '王强', email: 'wangqiang@demo.com', phone: '13800001003', position: '销售经理', role: 'sales_manager', employee_number: 'EMP003' },
    { name: '赵敏', email: 'zhaomin@demo.com', phone: '13800001004', position: '采购经理', role: 'procurement_manager', employee_number: 'EMP004' },
    { name: '陈刚', email: 'chengang@demo.com', phone: '13800001005', position: '仓库主管', role: 'inventory_manager', employee_number: 'EMP005' },
    { name: '刘洋', email: 'liuyang@demo.com', phone: '13800001006', position: '生产主管', role: 'production_manager', employee_number: 'EMP006' },
    { name: '孙丽', email: 'sunli@demo.com', phone: '13800001007', position: '质检主管', role: 'quality_manager', employee_number: 'EMP007' },
    { name: '周磊', email: 'zhoulei@demo.com', phone: '13800001008', position: '国内销售代表', role: 'viewer', employee_number: 'EMP008' },
    { name: '吴芳', email: 'wufang@demo.com', phone: '13800001009', position: '应付会计', role: 'viewer', employee_number: 'EMP009' },
    { name: '郑浩', email: 'zhenghao@demo.com', phone: '13800001010', position: '采购专员', role: 'viewer', employee_number: 'EMP010' },
    { name: '黄薇', email: 'huangwei@demo.com', phone: '13800001011', position: '应收会计', role: 'viewer', employee_number: 'EMP011' },
    { name: '马腾', email: 'mateng@demo.com', phone: '13800001012', position: '外贸业务员', role: 'viewer', employee_number: 'EMP012' },
    { name: '许杰', email: 'xujie@demo.com', phone: '13800001013', position: '车间组长', role: 'viewer', employee_number: 'EMP013' },
    { name: '徐静', email: 'xujing@demo.com', phone: '13800001014', position: '质检员', role: 'viewer', employee_number: 'EMP014' },
    { name: '韩涛', email: 'hantao@demo.com', phone: '13800001015', position: '仓管员', role: 'viewer', employee_number: 'EMP015' },
    { name: '曹勇', email: 'caoyong@demo.com', phone: '13800001016', position: '研发工程师', role: 'viewer', employee_number: 'EMP016' },
    { name: '谢莉', email: 'xieli@demo.com', phone: '13800001017', position: '行政助理', role: 'viewer', employee_number: 'EMP017' },
    { name: '邓鹏', email: 'dengpeng@demo.com', phone: '13800001018', position: '设备技术员', role: 'viewer', employee_number: 'EMP018' },
  ];
}
...
export function org1TaxCodes() {
  return [
    { code: 'VAT13', name: '增值税13%', rate: 13, tax_type: 'output' },
    { code: 'VAT9', name: '增值税9%', rate: 9, tax_type: 'output' },
    { code: 'VAT6', name: '增值税6%', rate: 6, tax_type: 'output' },
    { code: 'VAT0', name: '零税率', rate: 0, tax_type: 'output' },
    { code: 'INPUT13', name: '进项税13%', rate: 13, tax_type: 'input' },
  ];
}
...
export function org1Products(): Array<Record<string, unknown> & { _meta: ProductInfo }> {
  const products = [
    // Raw materials
    { code: 'RM-AL-001', name: '铝合金板材 6061-T6', type: 'material', cost_price: 45.00, list_price: 52.00, unit: 'KG', safety_stock_days: 14, lead_time_days: 7 },
    { code: 'RM-AL-002', name: '铝合金棒材 7075', type: 'material', cost_price: 68.50, list_price: 78.00, unit: 'KG', safety_stock_days: 14, lead_time_days: 10 },
    { code: 'RM-ST-001', name: '不锈钢管 304', type: 'material', cost_price: 32.00, list_price: 38.00, unit: 'M', safety_stock_days: 7, lead_time_days: 5 },
    { code: 'RM-ST-002', name: '不锈钢板 316L', type: 'material', cost_price: 85.00, list_price: 95.00, unit: 'KG', safety_stock_days: 14, lead_time_days: 10 },
    { code: 'RM-CU-001', name: '紫铜排', type: 'material', cost_price: 58.00, list_price: 65.00, unit: 'KG', safety_stock_days: 7, lead_time_days: 5 },
    { code: 'RM-PL-001', name: 'PA66 尼龙粒子', type: 'material', cost_price: 22.00, list_price: 28.00, unit: 'KG', safety_stock_days: 21, lead_time_days: 14 },
    { code: 'RM-RB-001', name: 'NBR 密封橡胶', type: 'material', cost_price: 120.00, list_price: 145.00, unit: 'KG', safety_stock_days: 30, lead_time_days: 21 },
    { code: 'RM-EL-001', name: '电子元器件套装 A', type: 'material', cost_price: 15.50, list_price: 22.00, unit: 'SET', safety_stock_days: 14, lead_time_days: 7 },
    // Semi-finished
    { code: 'SF-FR-001', name: '铝合金框架组件', type: 'semi_finished', cost_price: 180.00, list_price: 220.00, unit: 'PCS', safety_stock_days: 7, lead_time_days: 3 },
    { code: 'SF-SH-001', name: '不锈钢壳体', type: 'semi_finished', cost_price: 95.00, list_price: 120.00, unit: 'PCS', safety_stock_days: 7, lead_time_days: 3 },
    { code: 'SF-PCB-001', name: 'PCB 控制板', type: 'semi_finished', cost_price: 45.00, list_price: 65.00, unit: 'PCS', safety_stock_days: 14, lead_time_days: 5 },
    // Finished goods
    { code: 'FG-VLV-001', name: '工业电磁阀 DN25', type: 'finished_good', cost_price: 380.00, list_price: 520.00, unit: 'PCS', safety_stock_days: 14, lead_time_days: 7 },
    { code: 'FG-VLV-002', name: '工业电磁阀 DN50', type: 'finished_good', cost_price: 560.00, list_price: 780.00, unit: 'PCS', safety_stock_days: 14, lead_time_days: 7 },
    { code: 'FG-PMP-001', name: '离心泵 CYZ-50', type: 'finished_good', cost_price: 2800.00, list_price: 3800.00, unit: 'PCS', safety_stock_days: 7, lead_time_days: 14 },
    { code: 'FG-PMP-002', name: '自吸泵 ZW-80', type: 'finished_good', cost_price: 4200.00, list_price: 5600.00, unit: 'PCS', safety_stock_days: 7, lead_time_days: 14 },
    { code: 'FG-FLT-001', name: '精密过滤器 PF-100', type: 'finished_good', cost_price: 1500.00, list_price: 2100.00, unit: 'PCS', safety_stock_days: 7, lead_time_days: 10 },
    { code: 'FG-ACT-001', name: '气动执行器 AT-40', type: 'finished_good', cost_price: 850.00, list_price: 1200.00, unit: 'PCS', safety_stock_days: 7, lead_time_days: 7 },
    { code: 'FG-SNS-001', name: '压力传感器 PT-100', type: 'finished_good', cost_price: 320.00, list_price: 450.00, unit: 'PCS', safety_stock_days: 14, lead_time_days: 5 },
    // Packaging
    { code: 'PK-BOX-001', name: '标准纸箱 60x40x30', type: 'consumable', cost_price: 8.50, list_price: 12.00, unit: 'PCS', safety_stock_days: 30, lead_time_days: 3 },
    { code: 'PK-PLT-001', name: '木质托盘 1200x1000', type: 'consumable', cost_price: 65.00, list_price: 85.00, unit: 'PCS', safety_stock_days: 14, lead_time_days: 5 },
  ];
...
export function org1StorageLocations() {
  return [
    { warehouse_code: 'WH-MAIN', location_code: 'A-01-01', name: '主库A区1排1层', location_type: 'shelf' },
    { warehouse_code: 'WH-MAIN', location_code: 'A-01-02', name: '主库A区1排2层', location_type: 'shelf' },
    { warehouse_code: 'WH-MAIN', location_code: 'A-02-01', name: '主库A区2排1层', location_type: 'shelf' },
    { warehouse_code: 'WH-RAW', location_code: 'R-01-01', name: '原材料库1排1层', location_type: 'shelf' },
    { warehouse_code: 'WH-RAW', location_code: 'R-01-02', name: '原材料库1排2层', location_type: 'shelf' },
    { warehouse_code: 'WH-RAW', location_code: 'R-02-01', name: '原材料库2排1层', location_type: 'shelf' },
    { warehouse_code: 'WH-FIN', location_code: 'F-01-01', name: '成品库1排1层', location_type: 'shelf' },
    { warehouse_code: 'WH-FIN', location_code: 'F-01-02', name: '成品库1排2层', location_type: 'shelf' },
    { warehouse_code: 'WH-FIN', location_code: 'F-02-01', name: '成品库2排1层', location_type: 'shelf' },
  ];
}

export function org1Carriers() {
  return [
