...
registerRule({ id: 'manufacturing.issue_materials', domain: 'manufacturing', actionPattern: 'issue_materials', level: DecisionLevel.D2, roles: ['admin', 'manufacturing_manager', 'inventory_manager'] });
