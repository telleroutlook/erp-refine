...
registerRule({ id: 'contracts.renew', domain: 'contracts', actionPattern: 'renew_contract', level: DecisionLevel.D2, roles: ['admin', 'manager', 'sales_manager', 'procurement_manager'] });
