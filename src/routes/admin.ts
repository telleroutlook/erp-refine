...
const rolesConfig: CrudConfig = {
  ...
  detailSelect: 'id, name, description, is_system, organization_id, created_at, updated_at, permissions:role_permissions(id, resource, action, conditions)',
...
const userRolesConfig: CrudConfig = {
  ...
  detailSelect: 'id, user_id, role_id, organization_id, assigned_at, assigned_by, role:roles(id,name,description)',
