...
const departmentsConfig: CrudConfig = {
  ...
  listSelect: 'id, name, code, parent_id, level, status',
  detailSelect: '*, manager:employees(id, name)',
...
const employeesConfig: CrudConfig = {
  ...
  listSelect:
    'id, name, email, phone, position, role, status, employee_number, department:departments(id, name)',
  detailSelect: '*, department:departments(id, name, code)',
