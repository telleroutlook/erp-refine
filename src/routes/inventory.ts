...
const stockTransactionsConfig: CrudConfig = {
  ...
  listSelect: 'id, transaction_type, qty, reference_type, reference_id, lot_number, cost_price, notes, created_at, product:products(id,name,code), warehouse:warehouses(id,name)',
...
const inventoryLotsConfig: CrudConfig = {
  ...
  listSelect: 'id, lot_number, supplier_lot_number, manufacture_date, expiry_date, qty, status, product:products(id,name,code), warehouse:warehouses(id,name)',
  detailSelect: '*, product:products(id,name,code), warehouse:warehouses(id,name,code)',
