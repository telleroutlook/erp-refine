...
const accountSubjectsConfig: CrudConfig = {
  ...
  listSelect: 'id, code, name, category, balance_direction, parent_id, level, is_leaf, is_active',
...
const costCentersConfig: CrudConfig = {
  ...
  listSelect: 'id, code, name, parent_id, is_active, department:departments(id,name)',
  detailSelect: '*, parent:cost_centers(id,code,name), department:departments(id,name)',
  createReturnSelect: 'id, code, name',
  defaultSort: 'code',
  softDelete: false,
  orgScoped: true,
