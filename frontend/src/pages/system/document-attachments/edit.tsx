...
export const DocumentAttachmentEdit: React.FC = () => {
  ...
  return (
    <Edit saveButtonProps={saveButtonProps} title={pt('document_attachments', 'edit')}>
      <Form {...formProps} layout="vertical">
        <Row gutter={16}>
          <Col xs={24} sm={24} md={12}>
            <Form.Item label={fl('document_attachments', 'file_name')} name="file_name">
              <Input disabled />
            </Form.Item>
          </Col>
          <Col xs={24} sm={24} md={12}>
