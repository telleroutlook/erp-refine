...
export const ApprovalRuleCreate: React.FC = () => {
  ...
  return (
    <Create saveButtonProps={saveButtonProps} title={pt('approval_rules', 'create')}>
      <Form {...formProps} layout="vertical">
        <Row gutter={16}>
          ...
          <Col xs={24} sm={24} md={12}>
            <Form.Item label={fl('approval_rules', 'sequence_order')} name="sequence_order" initialValue={1} rules={[{ required: true, message: t('validation.required', { field: fl('approval_rules', 'sequence_order') }) }]}>
