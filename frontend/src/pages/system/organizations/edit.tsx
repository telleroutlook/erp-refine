...
export const OrganizationEdit: React.FC = () => {
  ...
  return (
    <Edit saveButtonProps={saveButtonProps} title={pt('organizations', 'edit')}>
      <Form {...formProps} layout="vertical">
        <Row gutter={16}>
          <Col xs={24} sm={24} md={12}>
            <Form.Item label={fl('organizations', 'name')} name="name" rules={[{ required: true }]}>
              <Input />
            </Form.Item>
          </Col>
          <Col xs={24} sm={24} md={12}>
            <Form.Item label={fl('organizations', 'code')} name="code" rules={[{ required: true }]}>
              <Input disabled />
            </Form.Item>
          </Col>
          <Col xs={24} sm={24} md={12}>
