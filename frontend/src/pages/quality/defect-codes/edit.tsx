...
export const DefectCodeEdit: React.FC = () => {
  ...
  return (
    <Edit saveButtonProps={saveButtonProps} title={pt('defect_codes', 'edit')}>
      <Form {...formProps} layout="vertical">
        <Row gutter={16}>
          <Col xs={24} sm={24} md={12}>
            <Form.Item label={fl('defect_codes', 'code')} name="code">
              <Input disabled />
            </Form.Item>
          </Col>
          <Col xs={24} sm={24} md={12}>
          ...
          <Col xs={24} sm={24} md={12}>
            <Form.Item label={fl('defect_codes', 'is_active')} name="is_active" valuePropName="checked">
              <Switch />
            </Form.Item>
          </Col>
        </Row>
