...
export const ProductUomConversionCreate: React.FC = () => {
  ...
  return (
    <Create saveButtonProps={saveButtonProps} title={pt('product_uom_conversions', 'create')}>
      <Form {...formProps} layout="vertical" initialValues={{ conversion_factor: 1, is_active: true }}>
        <Row gutter={16}>
