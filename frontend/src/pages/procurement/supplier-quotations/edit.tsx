...
export const SupplierQuotationEdit: React.FC = () => {
  ...
  const lineColumns: ColumnConfig[] = [
    { dataIndex: 'product_id', title: fl('supplier_quotation_lines', 'product_id'), editable: true, inputType: 'select', selectOptions: productSelectProps.options as any, render: (_: any, r: any) => r?.product?.name },
