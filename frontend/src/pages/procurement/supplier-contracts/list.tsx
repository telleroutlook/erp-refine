...
import { CONTRACT_STATUS_OPTIONS, translateOptions } from '../../../constants/options';

export const SupplierContractList: React.FC = () => {
  ...
  const { tableProps, setFilters } = useTable({
    ...
    filters: {
      permanent: [{ field: 'contract_type', operator: 'eq', value: 'procurement' }],
    },
  });
  ...
  return (
    <List
      title={t('menu.supplierContracts')}
      headerButtons={
