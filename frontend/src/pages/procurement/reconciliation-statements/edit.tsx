...
export const ReconciliationStatementEdit: React.FC = () => {
  ...
  const itemColumns: ColumnConfig[] = [
    ...
    { dataIndex: 'line_amount', title: '行金额', width: 120, align: 'right',
  ...
  return (
    <Edit saveButtonProps={saveButtonProps} title="编辑对账单">
      <Form {...formProps} layout="vertical">
        <Row gutter={16}>
          <Col xs={24} sm={24} md={12}><Form.Item label="对账单号" name="statement_no"><Input disabled /></Form.Item></Col>
          <Col xs={24} sm={24} md={12}><Form.Item label="状态" name="status"><Select options={RECONCILIATION_STATUS_OPTIONS} /></Form.Item></Col>
          ...
          <Col xs={24} sm={24} md={12}><Form.Item label="期间开始" name="period_start" {...dateFormItemProps}><DatePicker style={FULL_WIDTH} /></Form.Item></Col>
          <Col xs={24} sm={24} md={12}><Form.Item label="期间结束" name="period_end" {...dateFormItemProps}><DatePicker style={FULL_WIDTH} /></Form.Item></Col>
