    ...
    <Edit saveButtonProps={saveButtonProps} title="编辑销售发票">
      <Form {...formProps} layout="vertical">
        <Row gutter={16}>
          ...
          <Col xs={24} sm={24} md={12}>
            <Form.Item label="货币" name="currency"><Select options={CURRENCY_OPTIONS} disabled /></Form.Item>
          </Col>
          <Col span={24}>
      ...
      <EditableItemTable resource="sales-invoice-items" parentResource="sales-invoices" parentId={record?.id} parentFk="sales_invoice_id" items={record?.items ?? []} columns={itemColumns} title="发票行" />
    </Edit>
  );
};
