...
export const SupplierInvoiceCreate: React.FC = () => {
  const { formProps, saveButtonProps, onFinish } = useForm({ resource: 'supplier-invoices' });
  ...
  const { isCreateFrom, sourceData, isLoading: sourceLoading, sourceRef } = useCreateFrom('supplier-invoices');
