...
export const SupplierInvoiceEdit: React.FC = () => {
  ...
  const itemColumns: ColumnConfig[] = [
    { dataIndex: 'product_id', title: fl('supplier_invoices', 'product_id'), editable: true, inputType: 'select', selectOptions: productSelectProps.options as any, render: (_: any, r: any) => r?.product?.name },
